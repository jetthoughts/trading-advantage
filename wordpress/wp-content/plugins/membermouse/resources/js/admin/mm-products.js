...
var MM_ProductViewJS = MM_Core.extend({
	...
	{	
		...
		mmdialog_js.showDialog("mm-purchaselinks-dialog", this.module, 480, 275, "Purchase Links", values);
	},
	...
	addFieldOption: function(addImage, removeImage)
	{
		...
		html += "<a href=\"javascript:mmjs.removeFieldOption('mm-partner-container-" + optionId + "');\"><img src=\"" + removeImage + "\" style=\"vertical-align\" /></a>";
		html += "</div>";
