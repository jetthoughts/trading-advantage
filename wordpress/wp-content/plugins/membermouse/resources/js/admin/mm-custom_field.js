...
var MM_CustomFieldViewJS = MM_Core.extend({
	...
	addFieldOption: function(addImage, removeImage)
	{
		...
		jQuery('input.field-option').each(function( index ) {
			crntOptionId = $(this).attr('id').replace("mm-field-option-", ""); 
		...
		html += "<a href=\"javascript:mmjs.addFieldOption('" + addImage + "', '" + removeImage + "');\"><img src=\"" + addImage + "\" style=\"vertical-align\" /></a> ";
		html += "<a href=\"javascript:mmjs.removeFieldOption('mm-field-option-container-" + optionId + "');\"><img src=\"" + removeImage + "\" style=\"vertical-align\" /></a>";
		html += "</div>";
	...
	{	
		...
		mmdialog_js.showDialog("mm-smarttags-dialog", this.module, 480, 325, "Checkout Form SmartTag", values);
	},
});
