...
<a href="javascript:mmjs.updateAccessRights();" class="mm-button blue">Update Access</a>
...
<div class="mm-dialog-footer-container">
<div class="mm-dialog-button-container">
<a href="javascript:mmjs.saveAccessRight();" class="mm-button blue">Grant Access</a>
<a href="javascript:mmjs.closeDialog();" class="mm-button">Cancel</a>
</div>
</div>
<?php } else { ?>
