...
<div id="mm-form-container" style="background-color: #EAF2FA; padding-top:2px; padding-left:8px; padding-bottom:8px;">
		...
		<tr>
			...
			<table cellspacing="5">
				<tr>
					...
					<td>
						<select id="mm-memberships[]" size="6" multiple="multiple">
				...
				<tr>
					<td>Bundles</td>
					<td>
						<select id="mm-bundles[]" size="6" multiple="multiple">
			...
			<table cellspacing="5">
				<tr>
					...
					<td>
						<select id="mm-member-status-types[]" size="5" multiple="multiple">
	...
	<input type="button" class="mm-button blue small" value="Show Members" onclick="mmjs.search(0);">
