...
<p>
	<a href="http://support.membermouse.com/customer/portal/kb_article_attachments/15916/original.php?1369090080" class="mm-button small">
		<img src="<?php echo MM_Utils::getImageUrl("user"); ?>" style="vertical-align:middle;" /> Member Notification Script
	</a>
	<span style="margin-left:10px;"></span>
	<a href="http://support.membermouse.com/customer/portal/kb_article_attachments/15915/original.php?1369090074" class="mm-button small">
		<img src="<?php echo MM_Utils::getImageUrl("package"); ?>" style="vertical-align:middle;" /> Bundle Notification Script
	</a>
</p>
<p>
	<a href="http://support.membermouse.com/customer/portal/kb_article_attachments/20299/original.php?1379392587" class="mm-button small">
		<img src="<?php echo MM_Utils::getImageUrl("cash"); ?>" style="vertical-align:middle;" /> Payment Notification Script
	</a>
	<span style="margin-left:10px;"></span>
	<a href="http://support.membermouse.com/customer/portal/kb_article_attachments/20508/original.php?1379811533" class="mm-button small">
		<img src="<?php echo MM_Utils::getImageUrl("user_suit"); ?>" style="vertical-align:middle;" /> Affiliate Notification Script
	</a>
</p>
...
<div id="mm-action-send-email" style="display:none; margin-left:20px;">
	...
	<div>
		CC
		<img src="<?php echo MM_Utils::getImageUrl('information'); ?>" title="Enter emails addresses to CC separated by commas" style="vertical-align:middle;" />
	...
	<div style="margin-top:5px">
		...
		?>
		<br/>
		<em>Note: Only certain SmartTags can be used here</em>
...
<a href="javascript:mmjs.save();" class="mm-button blue">Save Push Notification</a>
