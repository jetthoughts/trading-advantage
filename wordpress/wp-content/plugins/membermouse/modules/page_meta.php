	...
	<div id="mm_access_rights_meta">
		<div style="padding:8px;">
			...
			<div style="text-align:right;">
				<input type='button' name='access_rights' value='Grant Access' onclick="accessrights_js.create('mm-post-meta-dialog', 420, 240);" class="mm-button green small"  />
			</div>
	...
	<div id='mm_core_pages_meta' style="<?php echo $p->mm_core_pages_meta_style; ?>">
		<div style="padding:8px;">
			...
			<div>
				...
				<?php if(isset($p->default_icon)) { ?>
					<a id='default_core_page' onclick="mmdialog_js.showDialog('mm-corepage-dialog', 'MM_CorePagesView', 420, 180, 'Change Core Page');" style="cursor: pointer; margin-left:5px;">
						<img src="<?php echo MM_Utils::getImageUrl('edit'); ?>" style="vertical-align:middle;"/>
					</a>
				<?php } ?>
			</div>
...
<script>jQuery("#mm-post-meta-dialog").dialog({autoOpen: false});</script>
<script>jQuery("#mm-corepage-dialog").dialog({autoOpen: false});</script>
