...
$availablePaymentServices = MM_PaymentServiceFactory::getPaymentServicesArray();
...
<div class="mm-wrap" id="mm-form-container">
	<div style='padding-left: 10px;'>
	    <div style='width:650px'>
			...
			<img src="<?php echo MM_Utils::getImageUrl("error"); ?>" style="vertical-align:middle;" /> <em>When collecting sensitive data on your site 
			...
			<a href="http://support.membermouse.com/customer/portal/articles/1073553-securing-your-site-with-https" target="_blank">steps you can take to secure your site</a>.</em>
			</p>
			<table width='750px'>
	...
	<input type='button' name='submit' value='Save Payment Methods' class="mm-button blue small" onClick="pymtSettings_js.paymentOptionsSave(jQuery('#mm-form-container :input').serializeArray()); return false;"/>
</form>