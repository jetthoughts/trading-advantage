...
function renderFieldOption($optionId, $affiliateId, $profileId)
{
	...
	<?php if($optionId > 1) { ?>
	<a href="javascript:mmjs.removeFieldOption('mm-partner-container-<?php echo $optionId; ?>');"><img src="<?php echo MM_Utils::getImageUrl("delete"); ?>" style="vertical-align:middle;" /></a>
	<?php } ?>
	</div>
<?php
}
...
<div id="mm-form-container">
	...
	<tr>
		<td>Status <img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="Inactive products cannot be purchased." /></td>
		<td>
	...
	<tr>
		...
		<td>
			...
			<div id="mm-access-container">
				...
				<input id="mm-associated-access-membership" type="radio" name="associated-access" value="membership" onclick="mmjs.accessChangeHandler()" <?php echo ($associatedMembership->isValid() ? "checked" : ""); ?> <?php echo ($hasBeenPurchased) ? "disabled" : ""; ?> /> Membership Level &nbsp; 
				<input id="mm-associated-access-bundle" type="radio" name="associated-access" value="bundle" onclick="mmjs.accessChangeHandler()" <?php echo ($associatedBundle->isValid() ? "checked" : ""); ?> <?php echo ($hasBeenPurchased) ? "disabled" : ""; ?> /> Bundle &nbsp;
			</div>
			...
			<div id='mm_rebill_row' style='display:none;'>
				...
				<p style="margin:5px 0px 5px 0px;">
				    ...
				    <span style='margin-left: 10px; vertical-align:middle;'>
				    	...
				    	<input type='text' id='mm-number_of_payments' value='<?php echo $product->getNumberOfPayments(); ?>'  style='width: 50px' <?php echo $enableNumberOfPayments;?> <?php echo ($hasBeenPurchased) ? "disabled" : ""; ?> /> 
				    	payments
				    </span>
	...
	<tr>
		<td>Description <img src="<?php echo MM_Utils::getImageUrl("information") ?>" style="vertical-align: middle" title="Enter a description for this product. It will be displayed in checkout forms when the [MM_Form_Data name='productDescription'] SmartTag is used." /></td> 
	...
	<tr>
		<td colspan="2">
			<p class="noticeMessage" style="font-size:10px;">
				...
				push notifications or WordPress hooks. Read this article to <a href="http://support.membermouse.com/customer/portal/articles/1309822-manually-integrate-with-an-affiliate-system" target="_blank">learn more about integrating with your affiliate system</a>.
			</p>
		</td>
	</tr>
	<?php } ?>
	...
	<tr>
		...
		<td>
			<div style="line-height:30px;">
				Commission Profile <img src="<?php echo MM_Utils::getImageUrl("information") ?>" style="vertical-align: middle" title="This is the commission profile that will be used when a customer who was referred by an affiliate purchases this product." />
				<br/>
	...
	<tr>
		<td>Purchase Confirmation Message <img src="<?php echo MM_Utils::getImageUrl("information") ?>" style="vertical-align: middle" title="Enter a purchase confirmation message for this product. It will be displayed to the member when they click to purchase a product using a card on file." /></td> 
		<td>
			<div>
...
<a href="javascript:mmjs.saveProduct();" class="mm-button blue">Save Product</a>
