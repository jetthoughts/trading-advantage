...
<div id="mm-form-container" style="width:460px;">
	<div style="font-size:11px;">
		<p>
			...
			MemberMouse checkout form. The SmartTag must be added between the <code>[MM_Form type='checkout']</code> and 
			<code>[/MM_Form]</code> SmartTags.
		</p>
		...
		Read this article to 
			<a href="http://support.membermouse.com/customer/portal/articles/1046687-mm_form_field-smarttag" target="_blank">learn more about the <code>MM_Form_Field</code> SmartTag</a>.
		</p>
	</div>
</div>