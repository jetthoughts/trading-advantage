...
<div class="mm-wrap">
    <p class="mm-header-text">Default Membership Level or Product <span style="font-size:12px;"><a href="http://support.membermouse.com/customer/portal/articles/1156498" target="_blank">Learn more</a></span></p>
    <div style="clear:both; height: 10px;"></div>
    <div style="margin-bottom:10px; width:450px;">Select the membership level or product MemberMouse should use if a customer visits the checkout
