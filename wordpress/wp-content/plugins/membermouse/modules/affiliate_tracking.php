...
<a href="" target="_blank">learn more about creating affiliate links</a>). Enter the parameter keywords below that you want to use
	...
	<table>
		...
		<tr>
			<td>
				...
				<img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="<?php echo $affiliateProviderDescription; ?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				...
				<span style="margin-left:10px; color:#999;">
					<img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="<?php echo $aliasDescription; ?>" />
...
<p><input type='submit' value='Save Settings' class="mm-button blue small" /></p>
</div>
</div>
</form>
