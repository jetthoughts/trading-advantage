...
<div id="mm-access_container_div">
	...
	<table id='access_rights_container_at_table' style='<?php echo $p->access_rights_at_style; ?>'>
		...
		<tr>
			<td>
				<img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="Access starts at zero so to grant access on the first day set this to 0, to grant access on the second day set this to 1, for access on the tenth set this to 9 and so on." />
				Grant access on day 
...
<a href="javascript:accessrights_js.save();" class="mm-button blue">Grant Access</a>
<a href="javascript:accessrights_js.closeDialog();" class="mm-button">Cancel</a>
</div>
</div>
