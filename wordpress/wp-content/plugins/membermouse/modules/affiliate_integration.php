...
<div class="mm-wrap">
	...
	<div id="mm-affiliate-provider-additional-options" style="display:none; margin-top:20px;">
		...
		<button id="affiliate-provider-save" class="mm-button blue small" onClick="mmjs.providerOptionsSave(jQuery('#provider-config-form :input').serializeArray()); return false;">Save Settings</button>
	</div>
