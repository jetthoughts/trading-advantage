...
<div id="mm-preview-settings-bar" style="<?php echo $cssStyles; ?>">
	<div style="float:left;">
		<span style="margin-right:10px;">
			MM Preview Settings
			<img src="<?php echo MM_Utils::getImageUrl("information") ?>" title="<?php echo $previewSettingsInfo; ?>" style="vertical-align: middle" />
		</span>
		<img src="<?php echo MM_Utils::getImageUrl("user") ?>" title="Select your membership level" style="vertical-align: middle" />
	...
	<div id="mm-member-options" style="float:left; margin-left:5px;">
		...
		<?php if($bundleCount>0){ ?>
			<div style='float:left; vertical-align:middle;'><a id='mm-showhide-preview-link' onclick="mmPreviewJs.showAccessTags()" style='cursor: pointer;'><img src='<?php echo MM_Utils::getImageUrl('package'); ?>' title='Select the bundles you have applied' /></a></div>
		...
		<span style="margin-left: 15px;">
			<img src="<?php echo MM_Utils::getImageUrl("calendar") ?>" style="vertical-align: middle" title="Select the number of days you've been a member" />
		...
		?>
			<span style="margin-left:20px;">
				...
				Seeing the error page unexpectedly? <a href="http://support.membermouse.com/customer/portal/articles/1168316-when-logged-in-as-an-administrator-i-m-seeing-an-error-page" target="_blank" style="color:rgb(62, 172, 207);">Make sure your settings are commited.</a>
			</span>
		<?php } ?>
