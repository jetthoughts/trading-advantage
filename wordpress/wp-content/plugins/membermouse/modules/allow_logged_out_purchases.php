...
<div class="mm-wrap">
    <p class="mm-header-text">Allow Logged Out Purchases <span style="font-size:12px;"><a href="http://support.membermouse.com/customer/portal/articles/1199354-allow-logged-out-member-s-to-make-purchases" target="_blank">Learn more</a></span></p>
    <div style="clear:both; height: 10px;"></div>
    <div style="margin-bottom:10px; width:450px;">Checking off the option below indicates that when a logged out user attempts 
    ...
    email address and they'll need to log in to make a purchase associated with that email address.</div>
	...
	<div>
		<label>
			...
			Allow existing members to make a purchase when they're logged out
		</label>
	</div>
</div>