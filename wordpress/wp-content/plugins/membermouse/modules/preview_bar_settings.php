...
<div class="mm-wrap">
    ...
    <p class="mm-header-text">Preview Settings Bar Options <span style="font-size:12px;"><a href="http://support.membermouse.com/customer/portal/articles/1163374-hide-the-preview-settings-bar" target="_blank">Learn more</a></span></p>
	...
	<div style="margin-top:10px;">
		...
		Show Preview Settings Bar
		<img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="<?php echo $showPreviewBarDesc; ?>" />
