...
<div id="mm-form-container">
	<table cellspacing="10">
		...
		<tr>
			<td>Status <img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="Members cannot sign up for inactive membership levels." /></td>
			<td>
		...
		<tr>
			...
			?>
			<td>WordPress Role <img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="<?php echo $wpRoleDescription; ?>" /></td>
			<td>
		...
		<tr>
			...
			<td>
				...
				<div id="mm-free-membership-settings" style="margin-top:5px; <?php if(!$membership->isFree()){ echo "display:none;"; } ?>">
					...
					Free Membership Description <em>(optional)</em>
					<img src="<?php echo MM_Utils::getImageUrl("information") ?>" style="vertical-align: middle" title="Enter a description below for this membership level. It will be displayed in checkout forms when the [MM_Form_Data name='productDescription'] SmartTag is used." />
					</span>
				...
				<div id="mm-paid-membership-settings" style="margin-top:5px; <?php if($membership->isFree()){ echo "display:none;"; } ?>">
					...
					<span style="font-size:11px;">
					Products
					<img src="<?php echo MM_Utils::getImageUrl("information") ?>" style="vertical-align: middle" title="Paid membership levels can have multiple products associated with them which allows you to offer different pricing for the same membership. Select one or more products below to associate with this membership level." /> 
					</span>
...
(Command key) + click</code>
		...
		<tr>
			<td>Bundles <img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="Select the bundles that members with this membership level should automatically get access to." /></td>
			<td>
...
(Command key) + click</code>
		...
		<tr>
			<td>Protected Categories <img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="Select the WordPress categories that should be automatically protected by this membership level." /></td>
			<td>
...
<a href="javascript:mmjs.save();" class="mm-button blue">Save Membership Level</a>
