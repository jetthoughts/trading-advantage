...
?>
<div class="mm-wrap">
    <p class="mm-header-text">Captcha Settings <span style="font-size:12px;"><a href="http://support.membermouse.com/customer/portal/articles/1223395-add-captcha-to-the-checkout-form" target="_blank">Learn more</a></span></p>
	<div style="margin-bottom:10px;">
		<img src="<?php echo MM_Utils::getImageUrl("recaptcha"); ?>" style="vertical-align:middle; margin-right:10px;" />
		<a target="_blank" href="https://www.google.com/recaptcha/admin/create" class="mm-button small green">Create a Free Account</a> 
		<a target="_blank" href="https://www.google.com/recaptcha/admin/" class="mm-button small">Access Existing Account</a>
	</div>
