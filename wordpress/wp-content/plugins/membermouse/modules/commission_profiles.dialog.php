			...
			<td>	
				...
				<div style="margin-top:5px; margin-left:20px; display: none;" id='rebill_commission_options'>
					...
					<p style="line-height:30px;" id="rebill_commission_type_selection">
						...
						<img src='<?php echo MM_Utils::getImageUrl("information"); ?>' style='vertical-align:middle;' title='The commission used on initial payment is based on the commission settings defined for the affiliate in the 3rd party affiliate configuration.' />
						...
						<img src='<?php echo MM_Utils::getImageUrl("information"); ?>' style='vertical-align:middle;' title='For flat rate commissions, express this value in the same currency that is set in your 3rd party affiliate configuration.' />
					</p>
					<?php } ?>
		...
		<tr>
			...
			<td>
				<div>
					...
					<img src='<?php echo MM_Utils::getImageUrl("information"); ?>' style='vertical-align:middle;' title='Only commissions that have not been paid out yet can be canceled.' />
				</div>
			</td>
		</tr>
	</table>
...
<a href="javascript:mmjs.save();" class="mm-button blue">Save Commission Profile</a>
