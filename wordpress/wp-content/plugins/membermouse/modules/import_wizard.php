...
<p class="mm-header-text">Import Wizard</p>
...
?>
	...
	<p style="margin-left:12px;">
		<a class="mm-button small" onclick="mmjs.downloadTemplate('<?php echo MM_MODULES_URL; ?>','<?php echo urlencode(MM_PLUGIN_ABSPATH."/templates/mm_import_template.csv"); ?>');"><img src="<?php echo MM_Utils::getImageUrl('page_white_go'); ?>" style="vertical-align: middle;" /> Download Import Template</a>
		<a class="mm-button small" onclick="stl_js.showIdLookup('');"><img src="<?php echo MM_Utils::getImageUrl("zoom"); ?>" title="ID Lookup" style="vertical-align:middle;" /> Lookup IDs</a>
		<a class="mm-button small" href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements" target="_blank"><img src="<?php echo MM_Utils::getImageUrl("us"); ?>" title="ISO Country Codes" style="vertical-align:middle;" /> ISO Country Codes</a>
	</p>
	...
	<p style="margin-left:12px; margin-top:20px;">
		...
		<span style="margin-left:10px; font-size:14px;">
			<?php echo MM_Status::getImage(MM_Status::$PENDING); ?> 6
		</span>
		<span style="margin-left:10px; font-size:14px;">
	...
	<tr>
		...
		<td>
			<div id="mm-uploaded-file-details" style='display:none;'>
				...
				<a onclick="mmjs.clearUploadedFile()" class="mm-button small" style='margin-left: 10px; float:left;'>Clear</a>
			...
			<div id="mm-file-upload-container">
				<form action="admin-ajax.php" name='file-upload' method="post" enctype="multipart/form-data" target="upload_target" onsubmit="mmjs.startUpload();" >
		            ...
		            <input type="submit" name="submitBtn" class="mm-button small" value="Upload" />
	...
	<p style="margin-left:12px;">
		...
		<input type='submit' class="mm-button large green" value='Import Members' />
	</p>
	</form>
<?php } ?>
</div>