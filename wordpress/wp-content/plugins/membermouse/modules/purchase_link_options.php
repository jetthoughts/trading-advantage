...
<div class="mm-wrap" style="padding-bottom:5px;">
    <p class="mm-header-text">Purchase Link Options <span style="font-size:12px;"><a href="http://support.membermouse.com/customer/portal/articles/1225553-configuring-purchase-links" target="_blank">Learn more</a></span></p>
    ...
    <div style="margin-left:15px;">
    	...
    	<div id="mm-disable-explicit-link-options">
    		<p>
				...
				<img src="<?php echo MM_Utils::getImageUrl("information"); ?>" style="vertical-align:middle;" title="<?php echo $linkSecurityDescription; ?>" />
			</p>
			<p></p>
