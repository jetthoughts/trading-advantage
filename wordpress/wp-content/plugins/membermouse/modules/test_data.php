...
?>
<p class="mm-section-header" style="margin-top:10px;"><img src="<?php echo MM_Utils::getImageUrl("wrench_orange"); ?>" style="vertical-align:middle;"> Test Data</p>
<p style="width:650px">
	...
	<tr>
		...
		<span style="font-family:courier; font-size:11px; margin-top:5px;">
			<?php 
				...
				{
					echo "<a onclick=\"javascript:showEmailInfo();\"><img src=\"".MM_utils::getImageUrl('information')."\" style=\"vertical-align:middle; cursor:pointer;\" title=\"Click for more information\" /></a>";
				}
				else if($field->fieldName == "username")
				{
					echo "<img src=\"".MM_utils::getImageUrl('information')."\" style=\"vertical-align:middle;\" title=\"Enter the base username to use for test accounts. MemberMouse will automatically add a series of numbers to the end of the base username to ensure that it's unique.\" />";	
				}
			?>
		</span>
		</td>
...
<p><input type='submit' name='submit' value='Save Test Data' class="mm-button blue small" /></p>
</form>
</div>
