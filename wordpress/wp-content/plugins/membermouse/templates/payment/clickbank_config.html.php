...
function validateClickbankProductConfigButton()
{
	...
	jQuery(".required_for_product_config").each(function() {
		if (jQuery(this).val() == "")
		{
...
jQuery(function($){
	...
	$(".required_for_product_config").keyup(validateClickbankProductConfigButton);
...
<a href='http://support.membermouse.com/customer/portal/articles/1080768-configuring-clickbank' target='_blank'>Need help configuring ClickBank?</a>
</div>
...
<div style="margin-bottom:10px;">
	...
	<p style="margin-left:10px; font-family:courier; font-size:11px;">
		<input type='text' value='<?php echo $p->getAPIClerkKey(); ?>' id='clickbank_api_clerk_key' class='required_for_product_config' name='payment_service[clickbank][api_clerk_key]' style='width: 275px;' />
	</p>
</div>
...
<div style="margin-bottom:10px;">
	...
	<p style="margin-left:10px; font-family:courier; font-size:11px;">
		<input type='text' value='<?php echo $p->getAPIDeveloperKey(); ?>' id='clickbank_api_developer_key' class='required_for_product_config' name='payment_service[clickbank][api_developer_key]' style='width: 275px;' />
	</p>
</div>
...
<div style="margin-bottom:10px;">
	...
	<p style="margin-left:10px; font-family:courier; font-size:11px;">
		<input type='text' value='<?php echo $p->getSecretKey(); ?>' id='clickbank_secret_key' class='required_for_product_config' name='payment_service[clickbank][secret_key]' style='width: 275px;' />
	</p>
</div>
...
<div style="margin-bottom:10px;">
	...
	<p style="margin-left:10px;">
		<?php $ipnUrl = WP_PLUGIN_URL.'/'.MM_PLUGIN_NAME."/x.php?service=clickbank"; ?>
		
		<span style="font-family:courier; font-size:11px; margin-top:5px;">
			 <input id="mm-clickbank-ipn-url" type="text" value="<?php echo $ipnUrl; ?>" style="width:550px" onclick="jQuery('#mm-clickbank-ipn-url').focus(); jQuery('#mm-clickbank-ipn-url').select();" />
		</span>
	</p>
...
<div style="margin-bottom:10px;">
	...
	<p style="margin-left:10px;">
		<?php $confirmationUrl = WP_PLUGIN_URL.'/'.MM_PLUGIN_NAME."/x.php?service=clickbank&op=conf"; ?>
		
		<span style="font-family:courier; font-size:11px; margin-top:5px;">
			 <input id="mm-confirmation-page-url" type="text" value="<?php echo $confirmationUrl; ?>" style="width:550px" onclick="jQuery('#mm-confirmation-page-url').focus(); jQuery('#mm-confirmation-page-url').select();" />
		</span>
	</p>
...
<div style="margin-bottom:10px;">
	...
	<p style="margin-left:10px;">
		<button id='clickbank_configure_products' class="mm-button grey small">Configure ClickBank Products</button>
	</p>
...
<div style="margin-bottom:10px;">
	...
	Read this article to <a href="http://support.membermouse.com/customer/portal/articles/1168422-create-a-fallback-confirmation-page-for-clickbank" target="_blank">learn more about creating a fallback confirmation page</a>.</p>
</div>
</div>