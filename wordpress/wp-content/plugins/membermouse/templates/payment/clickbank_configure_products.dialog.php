...
<div class="mm-dialog-footer-container">
	<div class="mm-dialog-button-container">
		<a onClick="saveClickbankProductMappings()" class="mm-button blue">Save Product Mappings</a>
		<a onClick="jQuery('#clickbank-configure-products-dialog').dialog('close');" class="mm-button">Cancel</a>
	</div>
</div>