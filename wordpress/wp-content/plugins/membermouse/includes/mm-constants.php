...
define("MM_LIB_DIR", dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR."lib");
...
// switch between jquery UI libraries based on WordPress version
if(version_compare(get_bloginfo('version'), "3.5.2", ">"))
{
	define("MM_JQUERY_UI_VERSION", "1.10.3");
}
else
{
	define("MM_JQUERY_UI_VERSION", "1.9.2");
}
...
define("MM_MODULE_MEMBER_DETAILS_BILLING_INFO", "details_billing_info");
define("MM_MODULE_MEMBER_DETAILS_SHIPPING_INFO", "details_shipping_info");
...
define("MM_MODULE_EVENT_LOG", "event_log");
