                ...
                <div class="formatted-form">
                    <form class="register-form" action="<?php echo AJAX_URL; ?>" method="POST">
                        ...
                        <div class="sixcol column">
                            <div class="field-wrapper">
                                <input type="password" name="user_password"
                                       placeholder="<?php _e('Password', 'academy'); ?>"/>
                            </div>
                        </div>
                        <div class="sixcol column last">
                            <div class="field-wrapper">
                                <input type="password" name="user_password_repeat"
                                       placeholder="<?php _e('Repeat Password', 'academy'); ?>"/>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <?php if (ThemexUser::getOption('captcha') == 'true') { ?>
                            ...
                            <div class="clear"></div>
                        <?php } ?>
                        <a href="#" class="button submit-button left"><span><span
                                    class="button-icon register"></span><?php _e('Register', 'academy'); ?></span></a>

                        <div class="form-loader"></div>
                        <input type="hidden" name="register_url"
                               value="<?php echo ThemexUser::$data['register_page_url']; ?>"/>
                        <input type="hidden" name="register_nonce" class="nonce"
                               value="<?php echo wp_create_nonce('register_nonce'); ?>"/>
        ...
        <div class="col-md-6">
            ...
            <div class="formatted-form">
                <form class="login-form" action="<?php echo AJAX_URL; ?>" method="POST">
                    ...
                    <a href="#" class="button submit-button left"><span><span
                                class="button-icon login"></span><?php _e('Sign In', 'academy'); ?></span></a>
                    <?php if (ThemexUser::getOption('facebook_login') == 'true') { ?>
                        <a href="#" title="<?php _e('Sign in with Facebook', 'academy'); ?>"
                           class="button facebook-button left">
                            <span><span class="button-icon facebook"></span></span>
                        </a>
                    <?php } ?>
                    <div class="form-loader"></div>
                    <input type="hidden" name="login_nonce" class="nonce"
                           value="<?php echo wp_create_nonce('login_nonce'); ?>"/>
