...
<?php //if(has_post_thumbnail()) { ?>
    ...
    <div class="course-preview <?php echo ThemexCourse::$data['course']['status']; ?>-course">
        <div class="course-image">
            ...
            <?php if (!empty(ThemexCourse::$data['course']['price']) && ThemexCourse::$data['course']['status'] != 'private') { ?>
        ...
        <div class="course-meta">
            <header class="course-header">
                ...
                <a href="<?php echo ThemexCourse::$data['course']['author']->user_link; ?>"
                   class="author"><?php echo ThemexCourse::$data['course']['author']->full_name; ?></a>
            </header>
            <?php if (ThemexCourse::$data['rating'] != 'true' || ThemexCourse::$data['users_number'] != 'true') { ?>
                <footer class="course-footer clearfix">
                    <?php if (ThemexCourse::$data['users_number'] != 'true') { ?>
                        <div
                            class="course-users left"><?php echo count(ThemexCourse::$data['course']['users']); ?></div>
                    <?php } ?>
...
<?php //$qq = ThemexCourse::$data['course']['lessons'];
//print_r($qq);
?>